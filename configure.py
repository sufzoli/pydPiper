            ...
            'questions': [
                {
                    ...
                    'allowed': [ 'winstar_weg', 'hd44780', 'hd44780_i2c', 'hd44780_spi', 'hd44780_mcp23008', 'luma_i2c' ],
                    ...
                    'followup_questions': {
                        ...
                        '^hd44780_spi$':
                            [
                                { 'prompt': 'SPI Port?', 'variable': 'DISPLAY_SPI_PORT', 'default': '0', 'help': 'What SPI bus is the display connected to' },
                                { 'prompt': 'SPI Address?', 'variable': 'DISPLAY_SPI_ADDR', 'default': '0', 'help': 'What SPI port (CS) is the display connected to' }
                            ],
                        '^luma_i2c$':
                            [
                        ...
                        '^hd44780$|^hd44780_i2c$|^hd44780_spi$|^hd44780_mcp23008$':
                            [
